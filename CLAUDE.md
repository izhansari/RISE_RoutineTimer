...
110 tests — mostly pure value-type math against synthetic dates; the suite runs in well under a second. The build should be warning-free; keep it that way.
